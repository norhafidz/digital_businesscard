...
<div class="card">
    ...
    <br/>
      <a class="text-white mont" href="index.php" style=""><i class="bi bi-house-door" style="font-size: 22px;"></i></a> <i class="bi bi-chevron-right text-white"></i> <a class="text-white mont" href="settings.php" style="font-size: 13px;">Settings</a> <i class="bi bi-chevron-right text-white"></i> <span class="text-white month" style="font-size: 13px;">Account settings</span><br/><br/>
       <div class="list-group">
            <a href="#" class="list-group-item list-group-item-action active" aria-current="true">
                <span class="" style="font-size: 15px;"><center><strong>Account settings</strong></center></span>
            </a>
            <a href="changememorable.php" class="list-group-item list-group-item-action"><span class="" style="font-size: 15px;"><center><strong>Memorable information</strong></center></span></a>
    <a href="changepass.php" class="list-group-item list-group-item-action"><span class="" style="font-size: 15px;"><center><strong>Change password</strong></center></span></a>
