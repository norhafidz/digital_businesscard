...
<div data-aos="fade-left"
   ...
   <i class="bi bi-chevron-left text-white"></i> <a class="text-white mont" href="a_settings.php" style="font-size: 12px;">Back</a><br/><br/>
    <span class="mont text-white" style="font-size: 18px;">Change password</span>
   <br/><br/>
        <div class="card">
            <div class="card-body" style="padding: 25px;">
            <form action="pass_change.php?id=<?php echo $user_idx; ?>" method="POST">
            <div class="mb-3">
                    <label for="memorable" class="form-label" style="font-size: 14px;">Memorable information: <a href="#" data-bs-toggle="modal" data-bs-target="#MemorableWhyModal" ><i class="bi bi-question-circle-fill text-primary"></i></a></label>
                        <input type="password" class="form-control" id="memorable" name="memorable" placeholder="" required>
                </div>
                <div class="mb-3">
                    <label for="current" class="form-label" style="font-size: 14px;">Current password:</label>
                        <input type="password" class="form-control" id="current" name="current" placeholder="" required>
                </div>
                <div class="mb-3">
                    <label for="newpass" class="form-label" style="font-size: 14px;">New password:</label>
                        <input type="password" class="form-control" id="newpass" name="newpass" placeholder="" required>
                </div>
                <div class="mb-3">
                    <label for="newpassconfirm" class="form-label" style="font-size: 14px;">Retype new password:</label>
                        <input type="password" class="form-control" id="newpassconfirm" name="newpassconfirm" placeholder="" required>
                </div>

                <div class="d-grid gap-2">
                    <button class="btn btn-dark" type="submit"><strong>Update password</strong></button>
                </div>
                </form>
            </div> 
            </div>
